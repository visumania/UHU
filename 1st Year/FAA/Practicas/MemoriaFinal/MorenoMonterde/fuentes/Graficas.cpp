...
void Graficas::generarGrafica(vector<string> nombreAlgoritmo)
{
    ...
    f << "set xlabel \"Talla (n)\"" << endl;
    f << "set ylabel \"Tiempo (ms)\"" << endl;
    f << "plot \"" << nombreAlgoritmo[0] << ".dat\" using 1:2 with lines title \"" << nombreAlgoritmo[0] << "\",\"" << nombreAlgoritmo[1] << ".dat\" using 1:2 with lines title \"" << nombreAlgoritmo[1] << "\",\"" << nombreAlgoritmo[2] << ".dat\" using 1:2 with lines title \"" << nombreAlgoritmo[2] << "\",\"" << nombreAlgoritmo[3] << ".dat\" using 1:2 with lines title \"" << nombreAlgoritmo[3] << "\"" << endl;
    f << "set terminal pdf" << endl;
