            ...
            do
            {
                ...
                case 3:
                    do
                    {
                        ...
                        if (opcM1ComparacionOrdenacion > 2 || opcM1ComparacionOrdenacion < 0)
                        {
                            system("cls");
                        ...
                        if (opcM2ComparacionOrdenacion > 2 || opcM2ComparacionOrdenacion < 0)
                        {
                            system("cls");
                    ...
                    } while (opcM1ComparacionOrdenacion > 2 || opcM1ComparacionOrdenacion < 0 || opcM2ComparacionOrdenacion>2 || opcM2ComparacionOrdenacion < 0 || opcM1ComparacionOrdenacion == opcM2ComparacionOrdenacion);
