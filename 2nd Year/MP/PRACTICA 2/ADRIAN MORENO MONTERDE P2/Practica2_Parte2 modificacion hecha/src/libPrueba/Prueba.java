	...
	public static void main(String[] args) 
	{
		...
		*/
		...
		//MAIN PARA COMPROBAR EL FUNCIONAMIENTO DE LA CLASE EMPRESA 
				...
				//Main para comprobar los ejercicios de la prueba de modificacion de java:
				...
				ladrona.robarClientesTarifaPlana(gcopia);
				
				System.out.println("\nEmpresa ladrona:\n"+ ladrona + "\ngocpia:\n" + gcopia);
				
				ClienteTarifaPlana ct1 = new ClienteTarifaPlana("467X", "Messi", fnac2.diaSig(), f3 , 300.00f, "Argentina");
				ClienteMovil cm = new ClienteMovil("777F", "Joe Sam", fnac2, 50.50f, 0.02f);
				
				System.out.println("El cliente mas antiguo entre \n" + ct1.getNombre() + " y \n " + cm.getNombre() + " es :\n" + Cliente.mayorQue(ct1, cm).getNombre() + " cuya fecha de alta es : " + Cliente.mayorQue(ct1, cm).getFechaAlta());
				
				Fecha f4 = new Fecha(31 , 12 , 2005);
				Fecha f5 = new Fecha(2,1,2018);
				
				ladrona.ganancia(f4, f5);
				
				
				//Main para comprobar los ejercicios de la prueba de modificacion de c++ trasladada a java:
				
				g.alta();
				
				System.out.println("Empresa g:\n" + g);
				
				ContratoMovilNavega.setPrecioMega(0.04f);
				
				System.out.println("Tras la subida del precio del mega consumido la Empresa g queda de la siguiente forma:\n" + g);
				...
				System.out.println("Tras la limpieza de clientes en las empresas , g se nos queda:\n" + g + "\ny gcopia:\n" + gcopia);
				*/
	}
}
