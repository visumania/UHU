...
public class ClienteTarifaPlana extends Cliente
{
	...
	static public float getPrecioTP()
	{
		return precioTP; 
	}
	...
	{
		if(this.minutosHablados > ClienteTarifaPlana.getLimite())
			return ClienteTarifaPlana.precioTP+(this.minutosHablados-ClienteTarifaPlana.getLimite())*ClienteTarifaPlana.getPrecioExcesoMinutos();
		else
			return ClienteTarifaPlana.precioTP;
	}
}
