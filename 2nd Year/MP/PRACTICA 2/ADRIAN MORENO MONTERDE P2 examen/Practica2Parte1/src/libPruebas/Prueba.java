...
public class Prueba 
{
	...
	public static void main(String[] args) 
	{
		...
		*/
		...
		//MAIN PARA COMPROBAR EL FUNCIONAMIENTO DE LA CLASE EMPRESA (POR TERMINAR)
		
				/*Fecha f1 = new Fecha(29,2,2001) , f2 = new Fecha(f1) , f3 = new Fecha(27,2,2004);
				...
				ct[0] = new ClienteTarifaPlana("805W", "Luz Casal", fnac1, f3, 375.09f, "Espa�ola");
				ct[1] = new ClienteTarifaPlana("953W", "Paz Padilla", fnac2, f2, 290.00f, "Espa�ola");
				...
				g.alta(cm1); g.alta(ct[0]); g.alta(c[2]); g.alta(cm2); g.alta(ct[1]); g.alta(cm3);
				g.alta(); g.alta(); //A�ade un ClienteMovil 100Z Pepe Luis , fnac 2/2/1972, minutosHablados 40.30, precioPorMinuto 0.04 , fAlta 1/1/2010 y otro nif 106T
				g.alta(ct[1]); //no lo debe añadir ya que existe
				
				System.out.println("Grupo g:\n" + g);
				
				g.baja("547B");  //elimina el cliente con nif 547F
