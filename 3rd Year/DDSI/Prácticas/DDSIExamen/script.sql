...
-- en la sentencia "DROP TABLE". En este caso, antes de borrar tablas,
-- deberíamos eliminar todas restricciones de integridad referencial que puedan
-- existir entre ellas
...
create table ACTIVIDAD (
    ...
    CONSTRAINT CAj_ActividadMonitor FOREIGN KEY (monitorResponsable) REFERENCES MONITOR(codMonitor));
