    ...
    public void actionPerformed(ActionEvent e) {
        switch (e.getActionCommand()) {
            ...
            case "AltaSocioActividad":
                ...
                if (act.addSocio(soc)) {
                    vMensajes.altaSocioActividadExito(numeroSocio, idActividad);
                } else {
                    vMensajes.altaSocioActividadError(numeroSocio, idActividad);
                }
            ...
            case "BajaSocioActividad":
                ...
                if (act.eliminaSocio(soc)) {
                    vMensajes.bajaSocioActividadExito(soc.getNombre(), act.getNombre());
                } else {
                    vMensajes.bajaSocioActividadError(soc.getNombre(), act.getNombre());
                }
