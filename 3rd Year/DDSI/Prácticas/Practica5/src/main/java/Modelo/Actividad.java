...
public class Actividad implements Serializable {
    ...
    public boolean addSocio(Socio socio) {
        return (socios.add(socio) && socio.getActividades().add(this));
    }

    public boolean eliminaSocio(Socio socio) {
        return (socios.remove(socio) && socio.getActividades().remove(this));
    }
}
